  ...
  return <>
    <ComponentOne>
      <Box sx={{position:"absolute", top:"50%", left:"50%", transform:'translate(-50%,-50%)', display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center"}}>
        <Typography component={isSm?"h3":isXs?"h3":"h2"} variant={isSm?"h3":isXs?"h3":"h2"} fontWeight={"bold"} color='#fff' mb={3} sx={{textAlign:"center"}}>{t('Cart')}</Typography>
        <Box sx={{display:'flex', justifyContent:"center", alignItems:"center", gap:2}}>
            ...
            <Typography color='#fff'>{t('Cart')}</Typography>
        </Box>
      </Box>
    </ComponentOne>
    <ComponentTwo />
