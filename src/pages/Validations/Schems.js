...
export const SignupValidationSchema = yup.object({
  ...
  email: yup.string().email("Invalid Email").required("Email Is Required"),
  userName: yup.string().required("User Name Is Required").min(4).matches(/^[a-zA-Z0-9._-]+$/,"Invalied User Name"),
  phoneNumber: yup.string().required("Phone Number Is Required").matches(/^[0-9]{3}-[0-9]{1}-[0-9]{3}-[0-9]{3}$/,"Invalid Phone")
