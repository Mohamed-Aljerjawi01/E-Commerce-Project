...
function Signup() {
  ...
  return <>
    ...
    <Box sx={{ width: "100%", height: "100vh", backgroundColor: "rgba(128,128,128,0.2)",display:"flex", justifyContent:"center", alignItems:"Center" }}>
      <Grid container sx={{ border: "3px solid #66bb6a", backgroundColor: mode==='dark'?'dark':'#fff', width: downSm ? "100%" : isSm ? "90%" : isMd ? "80%" : "80%", height: downSm ? "100vh" : downLg ? "90vh" : "80vh", boxShadow: "0px 0px 30px gray", borderRadius: downSm ? "0" : "20px", overflow: "auto" }}>
        <Box sx={{ display: "flex", flexDirection: downSm ? "column" : "row", gap: isXs ? 5 : 1, minHeight: "100%", width: "100%" }}>
          ...
          <Grid size={{ xs: 12, sm: 7}} sx={{ marginBottom: isXs ? "50px" : "15px", marginTop:upSm?"15px":"0", display:"flex", justifyContent:"center" }}>
            <Box sx={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 5 }}>
              <Typography component={"h3"} variant='h3' color='#66bb6a' sx={{ position: "relative", '&::after': { content: `""`, position: "absolute", bottom: "-10px", left: i18n.language==='en'?0:'30%', backgroundColor: "#66bb6a", width: "70%", height: "3px", borderRadius: "5px" } }}>{t('Sign Up')}</Typography>
